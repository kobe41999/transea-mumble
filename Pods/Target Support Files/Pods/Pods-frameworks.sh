...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods/DebugKit.framework"
  ...
  install_framework "Pods/JKVValue.framework"
  install_framework "Pods/Parse.framework"
  install_framework "Pods/ParseFacebookUtilsV4.framework"
  install_framework "Pods/RMQClient.framework"
...
if [[ "$CONFIGURATION" == "BetaDist" ]]; then
  install_framework "Pods/Bolts.framework"
  install_framework "Pods/CocoaAsyncSocket.framework"
  install_framework "Pods/DebugKit.framework"
  install_framework "Pods/DeviceUtil.framework"
